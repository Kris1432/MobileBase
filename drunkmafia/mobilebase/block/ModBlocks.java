...
public class ModBlocks {
	...
	public static Block tentBluePrinter;
	
	public static void init(){
		tentPost = new TentPostBlock();
		wool = new WoolBlock();
		tentBuilder = new TentBuilderBlock();
		tentBluePrinter = new TentBluePrinterBlock();
		...
		GameRegistry.registerTileEntity(TentBluePrinterTile.class, BlockInfo.tentBluePrinter_Tile);
